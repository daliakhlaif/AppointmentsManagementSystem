...
And the following upcoming appointments exist:
 ...
 | customer_id | customer_name  | appontment_date| start_time | end_time  | doctor   |  previous_visits  | 
 | 1           | Maher Amjad    |  10-11-2022    | 5:00pm     |  5:20pm   | mohammed |     1             |  
 | 2           | Basema Mohammad|  10-11-2022    | 12:00pm    |  1:00pm   | ali      |     3             | 
 | 3           | Osama Kamal    |  13-11-2022    | 12:00pm    |  12:30pm  | samer    |     0             |  
 ...
 Scenario: booking on an unavailable day 
      Given the user wants to book an appointment in "12-11-2022"
      And the appointment starts at "10:10am" and ends at "10:30am"
      When the user tries to book the appointment 
      Then he should get the message "not available on friday"     
...
Scenario: booking on an appointment for new patients successfully
      Given given the new patient "sara sameer" wants to book an appointment in "8-12-2022" at the doctor "ali"
...
Scenario: booking appointment when doctor not availabe
     Given the user wants to book an appointment in "10-12-2022" at the doctor "Eyad"
     And the appointment starts at "9:00am" and ends at "9:30am"
     When I add the appointment to the record
